$(document).ready(function(){
	...
	$(function () {
		...
		Highcharts.chart('line_chart_1', {
			...
			xAxis: {
				categories: ['Feb-16','Mar-16','Apr-16','May-16','Jun-16','Jul-16','Aug-16','Sep-16','Oct-16','Nov-16','Dec-16','Jan-17','Feb-17','Mar-17','Apr-17','May-17','Jun-17']
			},
			yAxis: {
				max:100,
			...
			series: [{
				...
				data: [4,31,50,56,56,79,86,93,93,93,93,93,93,97,97,97,100]
				...
				data: [4,31,50,52,52,52,52,52,52,52,52,52]
			}]
		});
	});
	...
	$(function () {
		...
		Highcharts.chart('line_chart_2', {
			...
			series: [{
				...
				data: [20,19,18,16,15,14,13,12,11,9,8,7,6,5,4,2,1,0]
				...
				data: [20,19,14,14,14,14,14,14,14,14,14,14]
			}]
		});
	});
	...
	var val_planned_value = 471600;
	var val_earned_value = 141800;
	var val_balance_value = 329800;
	...
	var json = [ 
		{"chart_title":"","chart_name":"","chart_id":"db_donut_0a","chart_val_planned":"93","chart_val_actual":"52","set_donut":"1","url":"#"}
	];
	...
	var milestone_due_data = [
		...
		{"taskname":"SR Consensus from President","baseline_start":"04 February 2016","baseline_finish":"12 February 2016","dayleft":"-359","pcomplete":"100%"},
		{"taskname":"SR Pre Contact","baseline_start":"07 March 2016","baseline_finish":"18 July 2016","dayleft":"-202","pcomplete":"48%"},
		{"taskname":"SR Post Contract","baseline_start":"19 July 2016","baseline_finish":"13 June 2017","dayleft":"128","pcomplete":"0%"}
	]
	...
	for (var i = 0; i < milestone_due_data.length; i++) {
		...
		$('.portlet_milestone_due tbody').append('<tr class="'+d_status+'"><td class=""><a href="milestone_seminar_a'+(i+1)+'.php">'+d_taskname+'</a></td><td class="set_center">'+d_baseline_s+'</td><td class="set_center">'+d_baseline_f+'</td><td class="set_center">'+d_dayleft+'</td><td class="set_center">'+d_variance+' Week(s)</td><td class="set_center">'+d_pcomplete+'</td></tr>')
