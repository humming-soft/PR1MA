$(document).ready(function(){
	...
	$(function () {
		...
		Highcharts.chart('line_chart_1', {
			...
			xAxis: {
				categories: ['May/16','Jun/16','Jul/16','Aug/16','Sep/16','Oct/16','Nov/16','Dec/16','Jan/17','Feb/17','Mar/17','Apr/17','May/17','Jun/17','Jul/17','Aug/17','Sep/17','Oct/17','Nov/17','Dec/17']
			},
			yAxis: {
				max:100,
			...
			series: [{
				...
				data: [5,9,27,41,47,53,59,65,71,77,83,93,93,93,93,93,97,97,97,100]
	...
	$(function () {
		...
		Highcharts.chart('line_chart_2', {
			...
			series: [{
				...
				data: [12,11,11,10,10,9,8,8,7,7,6,5,5,4,4,3,2,2,1,1,0]
	...
	var val_planned_value = 2041200;
	var val_earned_value = 70000;
	var val_balance_value = 1971200;
	...
	var json = [ 
		{"chart_title":"","chart_name":"","chart_id":"db_donut_0a","chart_val_planned":"71","chart_val_actual":"9","set_donut":"1","url":"#"}
	];
	...
	var milestone_due_data = [
		...
		{"taskname":"CT Pre Contact","baseline_start":"30 May 2016","baseline_finish":"25 July 2016","dayleft":"-195","pcomplete":"88%"},
		{"taskname":"CT Post Contract","baseline_start":"26 July 2016","baseline_finish":"27 December 2017","dayleft":"325","pcomplete":"0%"}
	]
	...
	for (var i = 0; i < milestone_due_data.length; i++) {
		...
		$('.portlet_milestone_due tbody').append('<tr class="'+d_status+'"><td class=""><a href="milestone_cooler_a'+(i+1)+'.php">'+d_taskname+'</a></td><td class="set_center">'+d_baseline_s+'</td><td class="set_center">'+d_baseline_f+'</td><td class="set_center">'+d_dayleft+'</td><td class="set_center">'+d_variance+' Week(s)</td><td class="set_center">'+d_pcomplete+'</td></tr>')
