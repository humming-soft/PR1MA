$(document).ready(function(){
	...
	$(function () {
		...
		Highcharts.chart('line_chart_1', {
			...
			xAxis: {
				categories: ['Mar-16','Apr-16','May-16','Jun-16','Jul-16','Aug-16','Sep-16','Oct-16','Nov-16','Dec-16','Jan-17','Feb-17','Mar-17','Apr-17','May-17']
			},
			yAxis: {
				max:100,
			...
			series: [{
				...
				data: [2,19,19,19,72,92,94,94,94,94,94,97,97,97,100]
				...
				data: [2,18,18,18,18,18,18,18,18,18,18]
			}]
		});
	});
	...
	$(function () {
		...
		Highcharts.chart('line_chart_2', {
			...
			xAxis: {
				categories: ['Mar/16','Apr/16','May/16','Jun/16','Jul/16','Aug/16','Sep/16','Oct/16','Nov/16','Dec/16','Jan/17','Feb/17','Mar/17','Apr/17','May/17','June/17']
			},
			yAxis: {
				title: {
					text: 'Numbers',
			...
			series: [{
				...
				data: [14,13,12,11,10,9,8,7,7,6,5,4,3,2,1,0]
				...
				data: [14,12,12,12,12,12,12,12,12,12,12]
			}]
		});
	});
	...
	var val_planned_value = 214400;
	var val_earned_value = 38640;
	var val_balance_value = 1175760;
	var val_actual_cost = val_earned_value+val_balance_value;
	var val_cost_overrun = val_actual_cost-val_planned_value;
	// if (val_cost_overrun == 0) {
	// 	var val_balance_value = val_planned_value-val_earned_value;
	// } else {
	// 	var val_balance_value = val_cost_overrun+val_planned_value-val_earned_value;
	// };
	...
	var json = [ 
		{"chart_title":"","chart_name":"","chart_id":"db_donut_0a","chart_val_planned":"94","chart_val_actual":"18","set_donut":"1","url":"#"}
	];
	...
	var milestone_due_data = [
		{"taskname":"BC CLEANING Pre Contact","baseline_start":"31 March 2016","baseline_finish":"04 July 2016","dayleft":"-216","pcomplete":"91%"},
		{"taskname":"BC CLEANING Post Contract","baseline_start":"05 July 2016","baseline_finish":"24 May 2017","dayleft":"108","pcomplete":"0%"}
	]
	...
	for (var i = 0; i < milestone_due_data.length; i++) {
		...
		$('.portlet_milestone_due tbody').append('<tr class="'+d_status+'"><td class=""><a href="milestone_bccleaning_a'+(i+1)+'.php">'+d_taskname+'</a></td><td class="set_center">'+d_baseline_s+'</td><td class="set_center">'+d_baseline_f+'</td><td class="set_center">'+d_dayleft+'</td><td class="set_center">'+d_variance+' Week(s)</td><td class="set_center">'+d_pcomplete+'</td></tr>')
