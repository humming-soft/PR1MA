$(document).ready(function(){
	...
	var val_planned_value = 402400;
	var val_earned_value = 312800;
	var val_balance_value = 89600;
	...
	var json = [ 
		{"chart_title":"","chart_name":"","chart_id":"db_donut_0a","chart_val_planned":"100","chart_val_actual":"78","set_donut":"1","url":"#"}
	];
	...
	var milestone_due_data = [
		...
		{"taskname":"TO ENGGAGE ENERGY MANAGEMENT SYSTEM CONSULTANT","baseline_start":"11 January 2016","baseline_finish":"6-Apr-16","dayleft":"-306","pcomplete":"100%"},
		{"taskname":"PROPOSAL TO CHANGE FLUORESCENT LIGHT TO LED","baseline_start":"30 May 2016","baseline_finish":"28-Jun-16","dayleft":"-223","pcomplete":"100%"},
		{"taskname":"MONITORING OF CAFETERIA ELECTRICAL CONSUMPTION USING LED","baseline_start":"17 August 2016","baseline_finish":"26-Dec-16","dayleft":"-42","pcomplete":"27%"}
	]
	...
	for (var i = 0; i < milestone_due_data.length; i++) {
		...
		$('.portlet_milestone_due tbody').append('<tr class="'+d_status+'"><td class=""><a href="milestone_green_a'+(i+1)+'.php">'+d_taskname+'</a></td><td class="set_center">'+d_baseline_s+'</td><td class="set_center">'+d_baseline_f+'</td><td class="set_center">'+d_dayleft+'</td><td class="set_center">'+d_variance+' Week(s)</td><td class="set_center">'+d_pcomplete+'</td></tr>')
